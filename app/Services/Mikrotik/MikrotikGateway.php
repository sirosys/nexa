 ...
 * Site — lihat CLAUDE.md "Integrasi MikroTik". Pola driver/adapter sama
 ...
 *
 * $site dikirim ke setiap method (bukan cuma host/kredensial mentah) supaya
 * driver 'log' bisa mencatat Site/router mana yang dituju TANPA interface
 * ini terikat ke bentuk kredensial koneksi tertentu — begitu driver
 * sungguhan dibangun (butuh kolom alamat jaringan baru di sites, belum ada
 * sama sekali saat ini), signature method di sini tidak perlu berubah.
 */
interface MikrotikGateway
{
    /**
     * Buat PPPoE secret baru di router milik $site.
     *
    ...
    /**
     * Cek apakah router milik $site bisa dijangkau saat ini — dipakai
     * scheduled command monitoring:check-site-status (lihat CLAUDE.md
