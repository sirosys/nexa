@php
    ...
    // "Coverage", "Layanan", "Penjualan", dan "Instalasi" yang mengarah ke
    // route sungguhan; sisanya placeholder sampai modul terkait dibangun
    // (lihat roadmap modul di README.md).
    $menu = [
