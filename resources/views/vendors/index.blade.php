<x-app-layout :title="'Vendor — ' . config('app.name', 'NEXA')">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Vendor</h1>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-1">
                                    <x-row-action :href="route('vendors.show', $vendor)" icon="eye" label="Detail" />
                                    @can('update', $vendor)
                                        <x-row-action :href="route('vendors.edit', $vendor)" icon="pencil-square" label="Ubah" variant="primary" />
                                    @endcan
                                    @can('delete', $vendor)
