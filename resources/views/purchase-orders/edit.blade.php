<x-app-layout :title="'Ubah Purchase Order — ' . config('app.name', 'NEXA')">
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ubah Purchase Order</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kode: {{ $purchaseOrder->code }}</p>
    </div>
