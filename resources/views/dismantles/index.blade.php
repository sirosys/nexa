...
<x-app-layout :title="'Dismantle — ' . config('app.name', 'NEXA')">
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Dismantle</h1>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="{{ route('dismantles.show', $service) }}" class="font-medium text-primary hover:underline">Detail</a>
                                </div>
                            </td>
                        </tr>
                    @empty
